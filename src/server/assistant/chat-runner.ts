...
export function buildChatPrompt(input: AssistantChatRunnerInput): string {
  return [
    ...
    "Every direct calendar registration or change must leave a change log through the MCP tool result.",
    ...
    "After a direct calendar tool call, mention the action id and whether it was applied or failed.",
